...
#include "My_font2/blur_x.h"
#include "My_font2/blur_y.h"
...
public:
    ...
    void init(const char* pixelShaderSrc) noexcept
    {
        if (initialized)
            return;
        initialized = true;
...
private:
    ...
    */
    ...
    void _draw(ImDrawList* drawList, ImVec2 min, ImVec2 max, float alpha) noexcept
    {
        ...
        ImTextureID blurTexture1;
        ImTextureID blurTexture2;
