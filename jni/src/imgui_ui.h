...
style.Colors[ImGuiCol_WindowBg] = ImVec4(0.86f, 0.86f, 0.86f, 0.0f); // 主窗口背景颜色透明

//style.Colors[ImGuiCol_WindowBg] = ImVec4(0.86f, 0.86f, 0.86f, 1.0f); // 主窗口背景颜色透明
...
// 滑动选择条
void qiyuannb(const vector<string>& names, float& 参数, float 居中 = 0, float 按钮x = 120, float 按钮y = 70, float 矩形圆角 = 17) {
